          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to="/register"
                  className="group inline-flex w-[14.5rem] items-center justify-center gap-2 px-8 py-3.5 bg-indigo-600 text-white font-medium rounded-full hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/30 hover:shadow-xl"
                >
                  Get started free
                  <svg className="w-4 h-4 group-hover:translate-x-0.5 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                ...
                <Link
                  to="/login"
                  className="inline-flex w-[14.5rem] items-center justify-center gap-1.5 px-8 py-3.5 border border-stone-300 text-stone-700 font-medium rounded-full hover:border-indigo-400 hover:text-indigo-700 transition bg-white"
                >
