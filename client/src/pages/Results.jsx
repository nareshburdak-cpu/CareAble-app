 ...
 *
 * Wrapped in <AssessmentSecurityShell> (without the warning notice)
 * to protect the certificate/results from casual screenshot sharing
 * via watermarking and other deterrence layers.
 */
...
function Results() {
  ...
  return (
    <AssessmentSecurityShell user={user} showNotice={false}>
